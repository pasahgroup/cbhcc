    ...
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        ...
        <div class="col-sm-2 d-flex justify-content-end gap-3">     
          ...
          <a href="<?php echo e(route('activity.create')); ?>" class="btn btn-gradient">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo e($data->activity_name); ?></td>
                 <td><?php echo e($data->activity_level); ?></td>
                 <td><?php echo e($data->activity_percent); ?></td> 
                 <td><?php echo e($data->status); ?></td>
                <td>
                
                  <form method="GET" action="<?php echo e(route('activity.edit',$data->id)); ?>" class="d-inline">
                    <?php echo csrf_field(); ?>
                  ...
                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/activity-destroy/<?php echo e($data->id); ?>" data-message="Are you sure you want to delete this activity?">
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/activity/activity.blade.php ENDPATH**/ ?>