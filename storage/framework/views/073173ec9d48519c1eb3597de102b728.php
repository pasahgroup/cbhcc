    ...
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        ...
        <div class="col-sm-2 d-flex justify-content-end gap-3">     
          ...
          <a href="<?php echo e(route('bank.create')); ?>" class="btn btn-gradient">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo e($data->bank_name); ?></td>
                 <td><?php echo e($data->swift_code); ?></td>
                 <td><?php echo e($data->bank_account_no); ?></td> 
                  <td><?php echo e($data->bank_holder_name); ?></td> 
                   <td><?php echo e($data->currency); ?></td> 
                    <td><?php echo e($data->country); ?></td> 

                 <td><?php echo e($data->status); ?></td>
                <td>                
                  <form method="GET" action="<?php echo e(route('bank.edit',$data->id)); ?>" class="d-inline">
                    <?php echo csrf_field(); ?>
                  ...
                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/bank-destroy/<?php echo e($data->id); ?>" data-message="Are you sure you want to delete this bank?">
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/bank/bank.blade.php ENDPATH**/ ?>