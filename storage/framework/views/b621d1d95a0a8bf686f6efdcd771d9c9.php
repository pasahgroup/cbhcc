<?php $__env->startSection('content'); ?>
  ...
  <section class="register">
    ...
    <!-- Registration Form (Start) -->
      ...
      <form class="account-form"  method="POST" action="<?php echo e(route('activity.store')); ?>" enctype="multipart/form-data">
                             <?php echo csrf_field(); ?>
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/activity/activity.blade.php ENDPATH**/ ?>