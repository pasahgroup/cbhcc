    ...
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        ...
        <div class="col-sm-2 d-flex justify-content-end gap-3">     
          ...
          <a href="<?php echo e(route('aboutus.create')); ?>" class="btn btn-gradient">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="<?php echo e(URL::asset('/storage/aboutus/'.$data->mission_photo)); ?>" alt="Mission Photo"></td>
                 <td><?php echo e($data->vision); ?></td>  
                 <td><img src="<?php echo e(URL::asset('/storage/aboutus/'.$data->vision_photo)); ?>" alt="Vision Photo"></td>           
                <td><?php echo e($data->status); ?></td>
                <td>
                
                  <form method="GET" action="<?php echo e(route('aboutus.edit',$data->id)); ?>" class="d-inline">
                    <?php echo csrf_field(); ?>
                  ...
                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/aboutus-destroy/<?php echo e($data->id); ?>" data-message="Are you sure you want to delete this asset?">
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/aboutus/aboutus.blade.php ENDPATH**/ ?>