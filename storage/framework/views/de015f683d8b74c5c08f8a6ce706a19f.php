    ...
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        ...
        <div class="col-sm-2 d-flex justify-content-end gap-3">     
          ...
          <a href="<?php echo e(route('project.create')); ?>" class="btn btn-gradient">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo e($data->project_name); ?></td>
                 <td><?php echo e($data->project_code); ?></td>
                ...
                <td>
                  ...
                  <form method="GET" action="<?php echo e(route('project.edit',$data->id)); ?>" class="d-inline">
                    <?php echo csrf_field(); ?>
                  ...
                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/project-destroy/<?php echo e($data->id); ?>" data-message="Are you sure you want to delete this asset?">
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/project/project.blade.php ENDPATH**/ ?>