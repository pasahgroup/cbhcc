    ...
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        ...
        <div class="col-sm-2 d-flex justify-content-end gap-3">     
          ...
          <a href="<?php echo e(route('donor.create')); ?>" class="btn btn-gradient">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo e($data->donor_name); ?></td>
                 <td><?php echo e($data->contact_name); ?></td>
                  <td><?php echo e($data->email); ?></td> 
                   <td><?php echo e($data->address); ?></td> 
                    <td><?php echo e($data->country); ?></td> 
            <td><img src="<?php echo e(URL::asset('/storage/donor_photos/'.$data->logo)); ?>" alt="The Logo"></td>
                 <td><?php echo e($data->status); ?></td>
                <td>                
                  <form method="GET" action="<?php echo e(route('donor.edit',$data->id)); ?>" class="d-inline">
                    <?php echo csrf_field(); ?>
                  ...
                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/donor-destroy/<?php echo e($data->id); ?>" data-message="Are you sure you want to delete this bank?">
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/donor/donor.blade.php ENDPATH**/ ?>