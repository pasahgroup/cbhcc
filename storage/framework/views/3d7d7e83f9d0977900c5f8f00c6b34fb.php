...
<div class="form-container">
    <div class="col-md-12">
    <form method="POST" id="post_form" role="form" class="registration-form" action="<?php echo e(route('donor.update',$donors->id)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
 <input type="hidden" name="_method" value="PUT">
        ...
        <input type="text" name="donor_name" value="<?php echo e($donors->donor_name); ?>" id="donor_name" class="form-control" maxlength="64" required>

  </div>
   
      <div class="col-md-2 col-sm-6">
         <label>Contact number</label>
         <input type="text" name="contact_number" value="<?php echo e($donors->contact_number); ?>" id="contact_number" class="form-control" maxlength="32" required>   
  </div>


      <div class="col-md-6 col-sm-12">
         <label>Email</label>
         <input type="email" name="email" value="<?php echo e($donors->email); ?>" id="email" class="form-control" maxlength="64" required>   
  </div>
  </div>
  ...
  <div class="form-group row">
      <div class="col-md-6 col-sm-12">
         <label>Address</label>
         <input type="text" name="address" value="<?php echo e($donors->address); ?>" id="address" class="form-control" maxlength="124" required>   
  </div>
  ...
  <div class="form-group row">
      <div class="col-md-6 col-sm-12">
         <label>Country</label>
         <input type="text" name="country" value="<?php echo e($donors->country); ?>" id="country" class="form-control" maxlength="40" required>   
  </div>
 
      <div class="col-md-6 col-sm-12">
        <label>Status</label>
         <select class="form-control" aria-label="Default select example" name="status" id="status">
          <option value="<?php echo e($donors->status); ?>"><?php echo e($donors->status); ?></option>
...
<option value="Inactive">Inactive</option>
    ...
    <div class="form-group row">
            ...
            <span class="img-div">
              ...
              <img src="<?php echo e(URL::asset('/storage/donor_photos/'.$donors->logo)); ?>" onClick="triggerClick()" id="profileDisplay">
            </span>
            </div>
           </div>
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/donor/editdonor.blade.php ENDPATH**/ ?>