<?php $__env->startSection('content'); ?>
 ...
 <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="swiper-slide home-item">
          <img src="<?php echo e(URL::asset('/storage/slides/'.$slide->photo)); ?>" alt="Home Image"> <!-- Slide Image -->
          <div class="content">
            <div class="text">
              <h3><?php echo e($slide->photo_title); ?> <i class="fas fa-hammer"></i></h3> <!-- Slide Subheading -->
              <p style="font-size:20px;color:#fff"><?php echo e($slide->photo_description); ?></p>
...
<div class="swiper-slide client-item"><a href="#"><img src="<?php echo e(URL::asset('/storage/donor_photos/'.$donor->logo)); ?>" alt="Client-Logo"  style="width:60px;height:40px"></a>

<p><?php echo e($donor->donor_name); ?></p>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('spa.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/home/home.blade.php ENDPATH**/ ?>