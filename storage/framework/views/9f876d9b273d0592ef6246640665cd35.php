...
<div class="form-container">
 ...
 <input type="hidden" name="_method" value="PUT">
        ...
        <input type="text" name="activity_name" placeholder="enter your activity name" id="activity_name" class="form-control"  value="<?php echo e($activity->activity_name); ?>" maxlength="64" required>

  </div>
 
      <div class="col-md-6 col-sm-12">
         <label>Activity level</label>
         <input type="text" name="activity_level" id="activity_level" class="form-control" value="<?php echo e($activity->activity_level); ?>" required>   
  </div>

      <div class="col-md-6 col-sm-12">
         <label>Activity percent</label>
         <input type="text" name="activity_percent" id="activity_percent" class="form-control" value="<?php echo e($activity->activity_percent); ?>" required>   
  </div>
      ...
      <div class="col-md-6 col-sm-12">
        <label>Status</label>
         ...
         <select class="form-control" aria-label="Default select example" name="status" id="status">
          <option value="<?php echo e($activity->status); ?>"><?php echo e($activity->status); ?></option>
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/activity/editactivity.blade.php ENDPATH**/ ?>