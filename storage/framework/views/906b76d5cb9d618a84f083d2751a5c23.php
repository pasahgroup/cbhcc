...
<div class="form-container">
    <div class="col-md-12">
<form method="POST" id="post_form" role="form" class="registration-form" action="<?php echo e(route('project.update',$project->id)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
 <input type="hidden" name="_method" value="PUT">
        ...
        <input type="text" name="project_name" id="project_name" class="form-control" maxlength="14" value="<?php echo e($project->project_name); ?>" required>
 ...
 <div class="form-group row">
      <div class="col-md-6 col-sm-12">
        ...
        <input type="text" name="project_code" id="project_code" class="form-control" maxlength="14" value="<?php echo e($project->project_code); ?>" required>    
  </div>
  </div>
  <div class="form-group row">
      <div class="col-md-6 col-sm-12">
        <label>region</label>
        <input type="text" name="region" id="region" class="form-control" maxlength="14" value="<?php echo e($project->region); ?>" required>    
  </div>
  </div>
  <div class="form-group row">
      <div class="col-md-6 col-sm-12">
        <label>district</label>
        <input type="text" name="district" id="district" class="form-control" maxlength="14" value="<?php echo e($project->district); ?>" required>    
  </div>
  </div>
  <div class="form-group row">
      <div class="col-md-6 col-sm-12">
        <label>start_date</label>
        <input type="date" name="start_date" id="start_date" class="form-control" maxlength="14" value="<?php echo e($project->start_date); ?>" required>    
  </div>
  </div>
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/project/editproject.blade.php ENDPATH**/ ?>