...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        ...
        <div class="col-sm-2 d-flex justify-content-end gap-3">    
          ...
          <a href="<?php echo e(route('register_slide')); ?>" class="btn btn-gradient">
  ...
  <section class="content">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td><?php echo e($data->id); ?></td>
                <td><?php echo e($data->photo_title); ?></td>
                 <td><img src="<?php echo e(URL::asset('/storage/slides/'.$data->photo)); ?>" alt="Slide Photo"></td>
                  <td><?php echo e($data->photo_description); ?></td>
                 <td><?php echo e($data->project_name); ?></td>  
                  <td><?php echo e($data->sub_project_name); ?></td>   
                   <td><?php echo e($data->display); ?></td>           
                <td><?php echo e($data->status); ?></td>
                <td>
                
                
                  <form method="GET" action="<?php echo e(route('edit_slide')); ?>" class="d-inline">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" value="PUT">
                    <input type="hidden" name="asset_id" value="#">
                    <input type="hidden" name="sessionf" value="#">
                    <input type="hidden" name="edit_slide" id="edit_slide"  value="<?php echo e($data->id); ?>">
                  ...
                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/slide-destroy/<?php echo e($data->id); ?>" data-message="Are you sure you want to delete this slide?">
...
<?php echo $__env->make('spa.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cbhcc\resources\views/admin/slides/slide.blade.php ENDPATH**/ ?>